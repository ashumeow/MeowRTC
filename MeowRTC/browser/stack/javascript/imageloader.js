...
function draw() {
	...
	try {
		...
		var modifyImageData   = meowImage(originalContext, originalImageData);
...
function initialize() {
	...
	var parent = document.getElementById("HelloMeowImage");
	for (var i = 0, l = meowImagePower.length; i < l; i++) {
		var elem = document.createElement("input");
		elem.type = "radio";
		elem.name = "HelloMeowImage";
	...
	document.getElementsByName("HelloMeowImage")[0].checked = true;
	meowImage = meowImagePower[0];
